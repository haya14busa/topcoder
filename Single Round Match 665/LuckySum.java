...
// CUT begin
	public static void main(String[] args){
		System.err.println("LuckySum (900 Points)");
		System.err.println();
	...
	static boolean doTest(String note, long __expected) {
		...
		long __result = 0;
		try {
			__result = instance.construct(note);
		}
	...
	static class Reader {
        private static final String dataFileName = "LuckySum.sample";
