...
// CUT begin
	public static void main(String[] args){
		System.err.println("ShopPositions (1000 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
	    ...
	    while (true) {
            ...
            if (doTest(n, m, c, __answer))
                passed++;
	    }
	    if (caseSet.size() > 0) cases = caseSet.size();
        System.err.println(String.format("%nPassed : %d/%d cases", passed, cases));

        int T = (int)(System.currentTimeMillis() / 1000) - 1441985436;
	...
	static boolean doTest(int n, int m, int[] c, int __expected) {
	...
	static class Reader {
        private static final String dataFileName = "ShopPositions.sample";
